...
class Die:
    ...
    def possible_score(self, score: int) -> bool:
        """
        Checks that the given score could be generated by this die

        :param score: The score to check
        :return: True if the given score can be generated by this die; otherwise, false
        """

        return self.min_possible_score <= score <= self.max_possible_score
