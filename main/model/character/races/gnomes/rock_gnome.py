...
class RockGnome(Gnome):
    ...
    def traits(self) -> Tuple[CollectionItem, ...]:
        ...
        return self._get_appended_collection(
            traits,
            "Tinker",
            "Using artisan's tools, you can spend 1 hour and 10 gp worth of materials to construct a Tiny clockwork "
            "device (AC 5, 1 hp). The device ceases to function after 24 hours (unless you spend 1 hour repairing it "
            "to keep the device functioning), or when you use your action to dismantle it; at that time, you can "
            "reclaim the materials used to create it. You can have up to three such devices active at a time.\n\n"
            "When you create a device, choose one of the following options:\n\n"
            "Clockwork Toy. This toy is a clockwork animal, monster, or person, such as a frog, mouse, bird, dragon, "
            "or soldier. When placed on the ground, the toy moves 5 feet across the ground on each of your turns in a "
